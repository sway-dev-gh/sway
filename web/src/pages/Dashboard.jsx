...
function Dashboard() {
  ...
  // FORCE REBUILD - Version 11 - Nov 9 2025 - Reduce all sizes by 10%
  const [loading, setLoading] = useState(true)
  // Build version for cache busting
  if (window.__BUILD_VERSION__ !== '1.0.5-20251109-v11') {
    window.__BUILD_VERSION__ = '1.0.5-20251109-v11'
  }
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{ fontSize: theme.fontSize.sm, color: theme.colors.text.tertiary, textTransform: 'uppercase', letterSpacing: '1.3px', marginBottom: theme.spacing[3], fontWeight: theme.weight.medium }}>Active Requests</div>
              <div style={{ fontSize: theme.fontSize['2xl'], fontWeight: theme.weight.semibold, color: theme.colors.white, lineHeight: '1', marginBottom: theme.spacing[2] }}>{stats.activeRequests}</div>
            ...
            <div style={{
              ...
              <div style={{ fontSize: theme.fontSize.sm, color: theme.colors.text.tertiary, textTransform: 'uppercase', letterSpacing: '1.3px', marginBottom: theme.spacing[3], fontWeight: theme.weight.medium }}>Total Uploads</div>
              <div style={{ fontSize: theme.fontSize['2xl'], fontWeight: theme.weight.semibold, color: theme.colors.white, lineHeight: '1', marginBottom: theme.spacing[2] }}>{stats.totalUploads}</div>
              <div style={{ fontSize: theme.fontSize.sm, color: theme.colors.text.muted }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: theme.fontSize.sm, color: theme.colors.text.tertiary, textTransform: 'uppercase', letterSpacing: '1.3px', marginBottom: theme.spacing[3], fontWeight: theme.weight.medium }}>Storage Used</div>
              <div style={{ fontSize: theme.fontSize['2xl'], fontWeight: theme.weight.semibold, color: theme.colors.white, lineHeight: '1', marginBottom: theme.spacing[2] }}>{formatStorageMB(stats.storageUsed)}</div>
              <div style={{ fontSize: theme.fontSize.sm, color: theme.colors.text.muted }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: theme.fontSize.sm, color: theme.colors.text.tertiary, textTransform: 'uppercase', letterSpacing: '1.3px', marginBottom: theme.spacing[3], fontWeight: theme.weight.medium }}>Total Requests</div>
              <div style={{ fontSize: theme.fontSize['2xl'], fontWeight: theme.weight.semibold, color: theme.colors.white, lineHeight: '1', marginBottom: theme.spacing[2] }}>{stats.totalRequests}</div>
              <div style={{ fontSize: theme.fontSize.sm, color: theme.colors.text.muted }}>
                All time
              </div>
            </div>
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: theme.fontSize.base, color: theme.colors.text.primary, fontWeight: theme.weight.medium, marginBottom: theme.spacing[7] }}>
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: theme.fontSize.base, color: theme.colors.text.primary, fontWeight: theme.weight.medium, marginBottom: theme.spacing[5] }}>
                    Request Types
                  </div>
